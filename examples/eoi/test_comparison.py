...
#    print str(dataset_handler)
    ...
    dsh1=DapExternalDataHandler(ret1[EXTERNAL_DATA_PROVIDER], ret1[EXTERNAL_DATA_SOURCE], ret1[EXTERNAL_DATA_SET], ret1[DAP_DS_DESC])

    ret1b = get_dataset(COMP1)
    dsh1b=DapExternalDataHandler(ret1b[EXTERNAL_DATA_PROVIDER], ret1b[EXTERNAL_DATA_SOURCE], ret1b[EXTERNAL_DATA_SET], ret1b[DAP_DS_DESC])

    ret2 = get_dataset(COMP2)
    dsh2=DapExternalDataHandler(ret2[EXTERNAL_DATA_PROVIDER], ret2[EXTERNAL_DATA_SOURCE], ret2[EXTERNAL_DATA_SET], ret2[DAP_DS_DESC])
