...
from prototype.sci_data.ctd_stream import ctd_stream_packet, ctd_stream_definition, usgs_stream_definition
...
class UsgsPublisher(StandaloneProcess):
    ...
    def on_start(self):
        ...
        self._usgs_def = usgs_stream_definition(stream_id=stream_id)
